...
// On Vercel serverless, only /tmp is writable; local dev uses ./data
const isVercel = process.env.VERCEL === '1';
const leadsDir = isVercel ? '/tmp' : path.join(__dirname, 'data');
...
// Export for Vercel serverless; run standalone when executed directly
module.exports = app;
